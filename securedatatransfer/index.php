    ...
    <div id="wrapper">
        <div id="left_pannel">
            <div id="user_info" style="padding: 10px;">
                <img id="profile_image" src="ui/images/blank-profile.png" style="height: 100px; width: 100px;">
                <br>
...
//alert(result);
    ...
    function logout_user(){
        ...
        var answer = confirm("Quit Chatting?");
        if(answer){
            get_data({},"logout");
        }
    }
    ...
    function send_message(e)
    {
        ...
        {
            alert("please thpe something to send");
            return;
        }
