...
function message_left($data,$row)
{
    ...
    <center>
        ...
        $a .= "<span style='font-size: 11px;color: white;'>".date("d M Y H:i:s a",strtotime($data->date))."</span>
...
function message_right($data,$row)
{
    ...
    <center>
        ...
        if($data->seen){
            $a .= "<img src='ui/icons/tick-blue.png' style=''>";
        ...
        $a .= "<span style='font-size: 11px;color: #888;'>".date("d M Y H:i:s a",strtotime($data->date))."</span>
...
function message_controls()
{
   return "
    ...
    <center><span style='color:grey;cursor:pointer' onclick='delete_thread(event)'>Delete this Chat</span></center>
    <center>
